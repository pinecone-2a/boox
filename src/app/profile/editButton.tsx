...
import { Plus, Image, Pencil, TrashIcon } from "lucide-react";
...
export const Editbutton = () => {
    ...
    const Editbutton = async (formData: FormData) => {
            ...
            <DialogContent className="flex flex-col gap-6 p-6">
                ...
                <form action={Editbutton}>
                    ...
                    <DialogFooter className="pt-6">
                        ...
                        <DialogClose asChild>
                            <Button variant="delete"><TrashIcon /></Button>
                        </DialogClose>
